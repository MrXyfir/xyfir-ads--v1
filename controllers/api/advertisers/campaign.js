...
module.exports = {
    ...
    */
    ...
    /*
        ...
        REQUIRED
            ...
            ct_categories: string, ct_keywords: string, ct_sites: string,
            ut_countries: string, ut_regions: string, ut_genders: string
        RETURN
    ...
    */
    update: function (req, res) {
        var response = { error: false, message: "Campaign updated successfully" };
        ...
        else if (!require("../../../lib/category/validator")(req.body.ct_categories, true))
        ...
        var update = [
            req.body.name, req.body.requested, req.body.available, req.body.ut_age,
            req.body.ct_categories, req.body.ct_keywords, req.body.ct_sites,
            req.body.ut_countries, req.body.ut_regions, req.body.ut_genders,
            req.params.id, req.session.uid
        ];
        var sql = ""
            + "UPDATE ads SET name = ?, requested = ?, available = ?, ut_age = ?, "
            + "ct_categories = ?, ct_keywords = ?, ct_sites = ?, "
            + "ut_countries = ?, ut_regions = ?, ut_genders = ? "
            + "WHERE id = ? AND owner = ?";
        /* Update data in table */
        db(function (cn) { return cn.query(sql, update, function (err, result) {
            cn.release();
            if (err)
